...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sukoon — Reminders & Chill Music for Focus" },
      { name: "description", content: "Listen to Islamic reminders, duas and chill study music. A calm space for focus." },
      { property: "og:title", content: "Sukoon — Reminders & Chill Music for Focus" },
      { name: "twitter:title", content: "Sukoon — Reminders & Chill Music for Focus" },
      { property: "og:description", content: "Listen to Islamic reminders, duas and chill study music. A calm space for focus." },
      { name: "twitter:description", content: "Listen to Islamic reminders, duas and chill study music. A calm space for focus." },
